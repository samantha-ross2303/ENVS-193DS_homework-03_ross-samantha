...
temp_min <- min(personal_data$high_temperature) # computing temp min for color scaling
temp_max <- max(personal_data$high_temperature)# computing temp max for color scaling
